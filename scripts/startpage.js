...
class startpage extends Phaser.Scene {
    ...
    create() {
        ...
        this.text = this.add.text(winW/2 - 140, winH/2 +20, "SPACE - fire, CURSOR KEYS - move your ship", {font: "16px Arial", fill: "#000000"});
        this.text = this.add.text(winW/2 - 60, winH/2 +40, "press fire to begin!", {font: "16px Arial", fill: "#000000"});
